...
// TODO: Need to rewrite these tests or the application since it cannot be tested
func TestHandleWebSocket(t *testing.T) {
	...
	for _, tt := range tcs {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			// Send Chat Messages. Need to rewrite this test since library does not support multiple concurrent read/writes
